...
import ProductAccountManager from "./pages/admin/ProductAccountManager.jsx";
import ProductDetailPage from "./components/user/product/ProductDetails.jsx";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route element={<UserLayout />}>
            ...
            <Route
              path="/netflix-mail"
              element={<NetflixUpdateHouseMailPage />}
            />
